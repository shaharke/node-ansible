...
AbstractAnsibleCommand.prototype.check = function() {
...
AbstractAnsibleCommand.prototype.addCheckMode = function(commandParams) {
  if (this.config.check) {
    commandParams = commandParams.concat('-C');
  }
  return commandParams;
};
...
AbstractAnsibleCommand.prototype.commonCompileParams = function(commandParams) {
  ...
  commandParams = this.addCheckMode(commandParams);
